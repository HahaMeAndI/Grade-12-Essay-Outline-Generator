...
export async function onRequest(context) {
    ...
    try {
        ...
        const prompt = `You are a helpful English writing assistant for a student in high school (grade 12). Generate a clear, structured, 4 paragraph essay outline for the following topic: "${topic}". The outline must include an introduction with a hook and thesis, two body paragraphs with topic sentences and supporting points, and a conclusion. Format the output using clear headings and bullet points.`;
